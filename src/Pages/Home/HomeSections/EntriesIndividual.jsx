...
import infoEntriesVip from "./IndividualEntriesVip.json";
import infoEntries from "./IndividualEntries.json";
const EntriesIndividual = () => {
  return (
    <div className="bg-verde relative z-5">
      <div className="max_width_container">
        <h1 className=" text-rosado text-center  ">entradas</h1>
        <h4 className="text-amarillo text-center  text-3xl lg:text-8xl font-frente">entradas individuales</h4>
...
export default EntriesIndividual;
